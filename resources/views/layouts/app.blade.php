                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        @switch($locale)
                            ...
                            @break
                            @case('jp')
                            <img src="{{asset('img/jp.png')}}" width="30px" height="20x"> Portugues
                            @break
                            @default
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="lang/pt-br"><img src="{{asset('img/jp.png')}}" width="30px" height="20x"> Portugues</a>
                        </div>
                    </li>
                </ul>
            </div>
